...
class PHPExcel_Writer_Excel2007 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    {
	    error_log("Excel2007.php save, med pFilename $pFilename");
	    ...
	    error_log("originalFilename $originalFilename");
	    ...
	    //error_log(print_r($this->stringTable, true));
	    ...
	    //PHPExcel_Settings::setZipClass(PHPExcel_Settings::ZIPARCHIVE);//test 2018
	    $zipClass = PHPExcel_Settings::getZipClass();
	    error_log("Will create new '" . print_r($zipClass) . "'");
            $objZip = new $zipClass();
	    ...
	    error_log("$pFilename is opened for writing");
	    ...
	    // Add media
	    error_log("Media count: " . $this->getDrawingHashTable()->count());
